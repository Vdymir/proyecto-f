        ...
        <header className='header'>
            ...
            <div className='header__container'>
                ...
                <div className="header__container-text">
                    ...
                    <p>Proyecto F es un proyecto personal el cual nace con el fin de aprender <span>frameworks</span> css. En este proyecto encontraremos varios <span>mini-proyectos</span> los cueles estaran estilados en su mayoria con frameworks css. <span>Inicialmente</span> estare creando mini-proyectos con <span>Bootstrap</span>, Tailwind y <span>Material-ui</span>.</p>
